...
class TestSearchService:
    ...
    def test_search_persons_limit(self, db_session, sample_data):
        ...
        results = service.search_persons(db_session, "", limit=1)  # Empty search should match all
    ...
    def test_search_tournaments_no_results(self, db_session, sample_data):
        ...
        results = service.search_tournaments(db_session, "NonExistentTournament", limit=10)
